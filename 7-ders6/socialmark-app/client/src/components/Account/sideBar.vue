<template>
      <aside class="flex flex-shrink-0 flex-col h-[100vh] bg-white w-60 border-gray-200 border-r-[1px]">
        <router-link class="sidebar-item" :to="{name:'Likes'}"  :class="{'sidebar-item-active': $route.name==='Likes'}">
        ...
        <router-link class="sidebar-item" :to="{name:'Favorites'}"  :class="{'sidebar-item-active': $route.name==='Favorites'}">
          <svg xmlns="http://www.w3.org/2000/svg" class="fill-current mr-2" height="24" viewBox="0 0 24 24" width="24">
        ...
        <router-link  :to="{name:'Settings'}"  class="sidebar-item"  :class="{'sidebar-item-active': $route.name==='Settings'}" >
