<template>
<aside class="sidebar">
  <a v-for="category in categoryList" :key="category.id" :id="category.id" @click="$emit('selected',$event)" class="sidebar-item" href="#" @click.prevent="$emit('category-changed',category.id)">
