<template>
<aside class="sidebar">
  <a v-for="category in categoryList" :key="category.id" active-class="sidebar-item-active" :id="category.id" class="sidebar-item" href="#" @click.prevent="$emit('category-changed',category.id)">
